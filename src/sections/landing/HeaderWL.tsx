...
const HeaderPage = () => {
  ...
  const [text, setText] = useState<string>(
    ...
    "With us, you'll be able to understand your legal matter and self-act safely and affordably."
  );
...
const HeaderPage = () => {
  ...
  const [text, setText] = useState<string>( // Specify type for useState
    ...
    "With Lōkahi Care, you'll be able to understand your legal matter and self-act safely and affordably."
  );
